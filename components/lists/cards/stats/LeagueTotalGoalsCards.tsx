...
import { LeagueTotalGoalsProps } from "@/types/totalStats";
import { Badge } from "@/components/ui/badge";

export default function LeagueTotalGoalsCards({
  teamsGoals,
  label,
}: {
  teamsGoals: LeagueTotalGoalsProps[];
  label: string;
}) {
  return (
    <Card>
